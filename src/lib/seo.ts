...
const META: Record<string, PageMeta> = {
  ...
  "/tool/photo-editor": {
    title: "فوتوشوب أونلاين مجاني — محرر Photopea كامل داخل المتصفح | Kraftoox",
    description: "محرر Photopea الاحترافي كامل الإمكانات داخل المنصة: طبقات، أقنعة، أدوات تحديد وفرش، ودعم PSD — افتح صورتك وعدّلها واحفظ النتيجة فوراً.",
  },
  "/tool/image-translator": {
    title: "ترجمة الصور بالذكاء الاصطناعي إلى العربية أونلاين | Kraftoox",
    description: "ارفع صورة فيها نصوص واطلب نسخة معرَّبة — يفهم ChatGPT (GPT-4o) التصميم ويترجم نصوصه مع الحفاظ على ستايل الكتابة والتخطيط، مع مقارنة وتنزيل فوري.",
  },
  "/tool/image-to-url": {
    title: "رفع الصور والحصول على رابط دائم أونلاين مجاناً | Kraftoox",
    description: "ارفع صورة واحصل فوراً على رابط CDN دائم لا ينتهي عبر Image2URL — مع أكواد HTML وMarkdown وBBCode وتحويل اختياري إلى SVG. الصور الكبيرة تُضغط تلقائياً.",
  },
  "/tool/compress-pdf": {
