...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    nameEn: "AI Image Translator (ChatGPT)",
    short: "ارفع صورة واطلب نسخة معرَّبة — يفهم ChatGPT التصميم ويترجم نصوصه مع الحفاظ على ستايل الكتابة والتخطيط.",
    shortEn: "Upload an image and ask for a translated version — ChatGPT reads the design and translates its text while preserving the typography style and layout.",
    long: "ترفع صورة فيها نصوص (بوستر، لقطة شاشة، إنفوجرافيك…) وتكتب ما تريده — مثلاً «هات نسخة بالعربي مع الحفاظ على ستايل الكتابة» — فيرسلها الموقع إلى ChatGPT (GPT-4o) الذي يفهم الصورة ويعيد رسمها بالنصوص المترجمة بنفس الألوان والخطوط والمواضع، ثم تقارن الأصل بالنسخة المعرَّبة وتنزّلها. مفتاح OpenAI يُحفظ محلياً ولا يمر على أي خادم تابع لنا.",
    longEn: "Upload an image with text (a poster, screenshot, infographic…) and type what you want — e.g. “give me an Arabic version keeping the writing style” — and the site sends it to ChatGPT (GPT-4o), which understands the image and redraws it with translated text in the same colors, fonts and positions. Compare the original with the result and download it. Your OpenAI key is stored locally and never touches our servers.",
    category: "image",
    icon: "globe",
    color: "var(--amber)",
    accept: "image/jpeg,image/png,image/webp,image/gif,.jpg,.jpeg,.png,.webp,.gif",
    multiple: false,
    badge: "AI · ChatGPT · OCR",
    badgeEn: "AI · ChatGPT · OCR",
    keywords: "ترجمة الصور ترجمة صورة بالعربي ترجمة الصور بالذكاء الاصطناعي image translation translate image text ai image translator تعريب الصور",
    keywordsEn: "translate image text ai image translation translate picture text to arabic ocr translate",
    features: [
      "يفهم التصميم ويحافظ على الستايل والتخطيط",
      "ترجمة إلى العربية وخمس لغات أخرى",
      "نموذجا GPT-4o و gpt-image-1",
      "مقارنة الأصل بالمعرَّب قبل التنزيل",
    ],
    featuresEn: [
      "Understands the design, keeps style & layout",
      "Translate to Arabic plus five more languages",
      "Both GPT-4o and gpt-image-1 models",
      "Compare original vs translated before download",
    ],
    drop: ["اسحب صورة فيها نصوص لترجمتها", "Drop an image with text to translate"],
    dropSub: ["بوستر · لقطة شاشة · إنفوجرافيك — سيترجم ChatGPT نصوصها بنفس الستايل", "Poster · screenshot · infographic — ChatGPT will translate its text in the same style"],
    action: ["ترجم الصورة", "Translate image"],
    note: [
      "تحتاج مفتاح OpenAI API (يُحفظ في متصفحك فقط). النماذج تستهلك من رصيد حسابك في OpenAI حسب الاستخدام.",
      "Requires an OpenAI API key (stored only in your browser). Models are billed against your OpenAI account balance.",
    ],
    isNew: true,
  },
  {
