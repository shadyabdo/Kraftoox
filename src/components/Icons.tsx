...
const P: Record<string, ReactNode> = {
  ...
  shrink: (
    <>
      <path d="M9.5 3.5V8a1.5 1.5 0 0 1-1.5 1.5H3.5M14.5 3.5V8A1.5 1.5 0 0 0 16 9.5h4.5M9.5 20.5V16A1.5 1.5 0 0 0 8 14.5H3.5M14.5 20.5V16a1.5 1.5 0 0 1 1.5-1.5h4.5" />
    </>
  ),
  eraser: (
    <>
